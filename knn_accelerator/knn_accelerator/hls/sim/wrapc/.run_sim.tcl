...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "knn_accelerator.autotvin.dat"
	set constFileTvOut       "knn_accelerator.autotvout.dat"
	set constFileHdlTvIn     "knn_accelerator.autohdltvin.dat"
	set constFileHdlTvOut    "knn_accelerator.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
