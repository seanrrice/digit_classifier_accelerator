...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.knn_accelerator.autotvin_gmem_x_test.dat"
         "c.knn_accelerator.autotvin_gmem_x_train.dat"
         "c.knn_accelerator.autotvin_gmem_y_train.dat"
         "c.knn_accelerator.autotvin_X_test.dat"
         "c.knn_accelerator.autotvin_X_train.dat"
         "c.knn_accelerator.autotvin_y_train.dat"
         "c.knn_accelerator.autotvin_y_test.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.knn_accelerator.autotvout_gmem_y_test.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {
