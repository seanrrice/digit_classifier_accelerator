...
if {[file isfile knn_accelerator.autotvin.dat]} {
	file delete -force knn_accelerator.autotvin.dat
}

if {[file isfile knn_accelerator.autotvout.dat]} {
	file delete -force knn_accelerator.autotvout.dat
}
