...
set C_modelArgMapList {[ 
	{ "Name" : "indvars_iv14", "interface" : "wire", "bitwidth" : 11, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ indvars_iv14 sc_in sc_lv 11 signal 0 } 
	{ distances_address0 sc_out sc_lv 11 signal 1 } 
	...
	{ distances_address1 sc_out sc_lv 11 signal 1 } 
	...
	{ labels_address0 sc_out sc_lv 11 signal 2 } 
	...
	{ labels_address1 sc_out sc_lv 11 signal 2 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "indvars_iv14", "direction": "in", "datatype": "sc_lv", "bitwidth":11, "type": "signal", "bundle":{"name": "indvars_iv14", "role": "default" }} , 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "7", "Max" : "7497"}
	, {"Name" : "Interval", "Min" : "7", "Max" : "7497"}
]}
...
set Spec2ImplPortList { 
	indvars_iv14 { ap_none {  { indvars_iv14 in_data 0 11 } } }
