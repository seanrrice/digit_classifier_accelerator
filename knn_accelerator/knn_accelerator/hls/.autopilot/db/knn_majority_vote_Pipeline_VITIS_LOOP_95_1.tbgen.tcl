set moduleName knn_majority_vote_Pipeline_VITIS_LOOP_95_1
set isTopModule 0
...
set cdfgNum 13
set C_modelName {knn_majority_vote_Pipeline_VITIS_LOOP_95_1}
...
set C_modelArgList {
	{ counts int 32 regular {array 10 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
set l_AXIML2Cache [list]
set AXIMCacheInstDict [dict create]
set C_modelArgMapList {[ 
	{ "Name" : "counts", "interface" : "memory", "bitwidth" : 32, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ counts_we0 sc_out sc_logic 1 signal 0 } 
	{ counts_d0 sc_out sc_lv 32 signal 0 } 
}
set NewPortList {[ 
...
set Spec2ImplPortList { 
	counts { ap_memory {  { counts_address0 mem_address 1 4 }  { counts_ce0 mem_ce 1 1 }  { counts_we0 mem_we 1 1 }  { counts_d0 mem_din 1 32 } } }
}
